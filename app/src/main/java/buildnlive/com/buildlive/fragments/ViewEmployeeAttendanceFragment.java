...
public class ViewEmployeeAttendanceFragment extends Fragment {
    ...
    public static ViewEmployeeAttendanceFragment newInstance() {
        return new ViewEmployeeAttendanceFragment();
    }
    ...
    private void refresh() {
        String requestUrl = Config.SEND_USER_ATTENDANCE_LIST;
